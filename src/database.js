export const database = {
	...
	DB_MICHAEL: {
		...
		city: 'Москва',
		technology: [
			{ protsent: '80%', name: 'HTML', color: '#ac1c02' },
			{ protsent: '70%', name: 'СSS', color: '#1f406b' },
			{ protsent: '10%', name: 'SСSS', color: '#d10073' },
			{ protsent: '80%', name: 'JS', color: '#cdb100' },
			{
				protsent: '60%',
				name: 'REACT (Redux, React Redux, React-router)',
				color: '#005aa9',
			...
			{ protsent: '50%', name: 'GIT', color: 'black' },
			{ protsent: '20%', name: 'Python', color: '#197547' },
			{ protsent: '10%', name: 'Django', color: '#197547' },
		],
		badge: [
			{
				title: 'Developer',
		...
		socialNetwork: {
			...
			telegram: 'https://t.me/Kulibars',
			github: 'https://github.com/Kulibars',
		},
	},
};
